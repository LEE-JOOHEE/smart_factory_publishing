...
import YrycEvlRegist01 from 'pages/usr/my/em/cr/yrycEvlRegist/comp/YrycEvlRegist01';
import SptEvlRgr05 from 'pages/usr/my/em/er/sptEvlRgr/comp/SptEvlRgr05';

const YrycEvlRegistContainer = ({ ojtKey, setPageType }) => {
...
export default React.memo(YrycEvlRegistContainer);
