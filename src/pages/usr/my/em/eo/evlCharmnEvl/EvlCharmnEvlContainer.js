...
import EvlCharmnEvl05 from 'pages/usr/my/em/eo/evlCharmnEvl/comp/EvlCharmnEvl05';

const EvlCharmnEvlContainer = ({ ojtKey, setPageType }) => {
...
export default React.memo(EvlCharmnEvlContainer);
