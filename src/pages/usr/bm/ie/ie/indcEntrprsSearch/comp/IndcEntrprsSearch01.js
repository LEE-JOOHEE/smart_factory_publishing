      ...
      <Row className="eu-usr-row-comp-cont">
        <Col span={24}>
          <Descriptions bordered size="small">
            <Descriptions.Item label="도입기업소재지지">
              <Select
                onChange={(value) => {
            ...
            <Descriptions.Item label="매출규모" span={2}>
              <Select
                onChange={(value) => {
                  ojtChange(value, 'a10', setOjtSrchCnd);
                }}
                options={[
                  {
                    value: '',
...
export default IndcEntrprsSearch01;
