...
import PrmpcSprvisnPresentn01 from 'pages/usr/bm/pc/ps/prmpcSprvisnPresentn/comp/PrmpcSprvisnPresentn01';

const PrmpcSprvisnPresentnContainer = ({ setOjtKey, setPageType }) => {
...
export default React.memo(PrmpcSprvisnPresentnContainer);
