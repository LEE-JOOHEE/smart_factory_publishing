...
const ReprtExmntList02 = ({ arrAsmtLst, setOjtKey, setPageType }) => {
  const columns = [
  ...
  const [levelExmntPopupOpen, setLevelExmntPopupOpen] = useState(false);
  return (
    <>
...
export default ReprtExmntList02;
