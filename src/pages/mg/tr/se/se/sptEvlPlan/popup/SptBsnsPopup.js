...
const arrEvlAltmntColumns = [
  ...
  { title: '사업', dataIndex: 'b', width: '32%', },
  { title: '수행기관(TP)', dataIndex: 'c', width: '15%', },
  { title: '전체', dataIndex: 'd', width: '10%', align: 'center', },
  { title: '대상과제수', dataIndex: 'e', width: '11%', align: 'center', },
  { title: '배정과제수', dataIndex: 'f', width: '11%', align: 'center', },
  { title: '배정상태', dataIndex: 'g', width: '10%', align: 'center', },
];

const SptBsnsPopup = ({ cmEvlAltmntSttsOpen, setCmEvlAltmntSttsOpen }) => {
  //검색조건
