...
const DlbrtTaskPopupPage = ({ asmtRegPopupOpen, setAsmtRegPopupOpen }) => {
  ...
  const arrAltmntAsmtColumns = [
    ...
    { title: '현장평가점수', dataIndex: 'e', width: 200 },
    { title: '현장평가결과', dataIndex: 'f' },
    { title: '종합점수', dataIndex: 'g' },
    { title: '기술성평가결과', dataIndex: 'h' },
    { title: '현장확인적합성', dataIndex: 'i', width: 90 },
    { title: '현장확인결과', dataIndex: 'j', width: 90 },
    {
      title: '제외',
      dataIndex: 'k',
      render: (_, record) => {
  ...
  const arrUnAltmntAsmtColumns = [
    ...
    { title: '과제번호', dataIndex: 'b', width: 80 },
    { title: '과제명', dataIndex: 'c', width: 200 },
    { title: '도입기업명', dataIndex: 'd', width: 180 },
    { title: '현장평가점수', dataIndex: 'e', width: 200 },
    { title: '현장평가결과', dataIndex: 'f' },
    { title: '종합점수', dataIndex: 'g' },
    { title: '기술성평가결과', dataIndex: 'h' },
        ...
        <Row className="eu-row-comp-cont">
          <Col span={24}>
            <Descriptions bordered size="small">
              ...
              <Descriptions.Item label="현장평가결과">
                <Select
                  onChange={(value) => {
              ...
              <Descriptions.Item label="기술성평가결과">
                <Select
                  onChange={(value) => {
              ...
              <Descriptions.Item label="현장확인결과" span={3}>
                <Select
                  onChange={(value) => {
