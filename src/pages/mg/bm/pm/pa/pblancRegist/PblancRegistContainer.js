...
import PblancRegist01 from 'pages/mg/bm/pm/pa/pblancRegist/comp/PblancRegist01';
import PblancRegist02 from 'pages/mg/bm/pm/pa/pblancRegist/comp/PblancRegist02';
import PblancRegist03 from 'pages/mg/bm/pm/pa/pblancRegist/comp/PblancRegist03';
import PblancRegistPopup from 'pages/mg/bm/pm/pa/pblancRegist/popup/PblancRegistPopup';

const PblancRegistContainer = ({ setPageType }) => {
  ...
  return (
    <>
      ...
      <Row className="eu-row-page-comp-layout">
        <Col span={24}>
          <PblancRegist02 pbancCpy={pbancCpy} />
        </Col>
      </Row>
      <Row className="eu-row-page-comp-layout">
        <Col span={24}>
...
export default React.memo(PblancRegistContainer);
