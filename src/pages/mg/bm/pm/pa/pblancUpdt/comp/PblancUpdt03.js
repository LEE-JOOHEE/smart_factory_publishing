...
const PblancUpdt03 = ({
  ...
  // 첨부 메소드
  const atchClick = () => {
    console.log('atchClick');
    Modal.info({ title: 'atchClick' });
  };
  // 공고 첨부파일 column
  ...
  const insertFlfmtBizClick = () => {
    console.log('insertFlfmtBizClick');
    Modal.info({ title: 'insertFlfmtBizClick' });
  };
  ...
  const deleteFlfmtBizClick = () => {
    console.log('deleteFlfmtBizClick');
    Modal.info({ title: 'deleteFlfmtBizClick' });
  };
