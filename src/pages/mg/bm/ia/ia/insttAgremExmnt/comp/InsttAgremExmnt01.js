...
import { Col, Row, Tabs, Button, Descriptions, Select, Input } from 'antd';
import TitleComp from 'components/layout/TitleComp';
import 'css/Common.css';

const InsttAgremExmnt01 = ({ searchClick }) => {
      ...
      <Row className="eu-row-comp-cont">
        <Col span={24}>
          <Descriptions size={'small'} bordered>
            ...
            <Descriptions.Item label="지역(수행기관" span={2}>
              <Select
                onChange={(value) => {
            ...
            <Descriptions.Item label="수행기관 진행상태">
              <Select
                onChange={(value) => {
...
export default InsttAgremExmnt01;
