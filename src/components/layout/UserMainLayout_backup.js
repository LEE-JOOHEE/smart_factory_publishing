      ...
      <div className="eu-user-container" onClick={() => setDropMenuOpen(false)}>
        <div className="eu-user-header">
          ...
          <div className="inner">
            <div className="eu-u-header-menu">
              <div className="eu-kosmo-logo-user">
                <Link to="/" tabIndex={9}><img src={logoUserMainFull} alt="user-main-logo-full" className="logo-full mt-4" /></Link>
                <Link to="/" tabIndex={9}><img src={logoUserMain} alt="user-main-logo" className="logo-mini mt-6" /></Link>
              </div>
              <div className="eu-main-menu">
                <Link to="/" tabIndex={10} onMouseEnter={openDropMenu} onKeyDown={openDropMenu}><span>사업안내</span></Link>
                <Link to="/" tabIndex={16} onMouseEnter={openDropMenu}><span>홍보관</span></Link>
                <Link to="/" tabIndex={23} onMouseEnter={openDropMenu}><span>사업관리</span></Link>
                <Link to="/" tabIndex={36} onMouseEnter={openDropMenu}><span>알림/참여마당</span></Link>
                <Link to="/" tabIndex={41} onMouseEnter={openDropMenu}><span>기관소개</span></Link>
              </div>
            </div>
          </div>
          ...
          <div className="tablet-sub-menu scroll-x-hide">
            <div className="link-scroll-wrap">
              <Link to="/"><span className="active">사업안내</span></Link>
              <Link to="/"><span>지원사업 소개</span></Link>
              <Link to="/"><span>담당자 연락처</span></Link>
              <Link to="/"><span>공급기업 소개</span></Link>
              <Link to="/"><span>맞춤형 공급기업 검색1</span></Link>
              <Link to="/"><span>맞춤형 공급기업 검색2</span></Link>
              <Link to="/"><span>맞춤형 공급기업 검색3</span></Link>
              <Link to="/"><span>맞춤형 공급기업 검색4</span></Link>
              <Link to="/"><span>맞춤형 공급기업 검색5</span></Link>
              <Link to="/"><span>맞춤형 공급기업 검색6</span></Link>
              <Link to="/"><span>맞춤형 공급기업 검색7</span></Link>
              <Link to="/"><span>맞춤형 공급기업 검색8</span></Link>
            </div>
          </div>
          ...
          {isDropMenuOpen && (
            <>
            <div className="eu-u-menu-structure" onMouseLeave={() => setDropMenuOpen(false)}>
              <div className="menu-bg-left col-span-5">
                <img src={MenuStructureBg} alt="메뉴구조도 배경이미지" />
              </div>
                ...
                <div className="inner">
                  <div className="img-inner">
                    <div className="img-text">
                      스마트공장 사업관리시스템에서 정보들을<br/>
                      체계적으로 분류하여 보여드립니다.
                    </div>
                  </div>
                  <div className="list-inner">
                    <div className="menu-list">
                      <Link to="/" tabIndex={11}>사업공고</Link>
                      <Link to="/" tabIndex={12}>지원사업 소개</Link>
                      <Link to="/" tabIndex={13}>담당자 연락처</Link>
                      <Link to="/" tabIndex={14}>공급기업 소개</Link>
                      <Link to="/" tabIndex={15}>맞춤형 공급기업 검색</Link>
                    </div>
                    <div className="menu-list">
                      <Link to="/" tabIndex={17}>스마트공장소개</Link>
                      <Link to="/" tabIndex={18}>유관사업안내</Link>
                      <Link to="/" tabIndex={19}>우수구축사례</Link>
                      <Link to="/" tabIndex={20}>보도자료</Link>
                      <Link to="/" tabIndex={21}>홍보자료</Link>
                      <Link to="/" tabIndex={22}>제조혁신센터소개</Link>
                    </div>
                    <div className="menu-list">
                      <Link to="/" tabIndex={24}>과제신청</Link>
                      <Link to="/" tabIndex={25}>공급기업 매칭</Link>
                      <Link to="/" tabIndex={26}>기업진단 현장평가</Link>
                      <Link to="/" tabIndex={27}>원가계산</Link>
                      <Link to="/" tabIndex={28}>컨설팅기관 지정</Link>
                      <Link to="/" tabIndex={29}>평가/점검결과조회</Link>
                      <Link to="/" tabIndex={30}>이의신청</Link>
                      <Link to="/" tabIndex={31}>협약/사업비</Link>
                      <Link to="/" tabIndex={32}>보고/감리</Link>
                      <Link to="/" tabIndex={33}>성과관리</Link>
                      <Link to="/" tabIndex={34}>하자보수 관리</Link>
                      <Link to="/" tabIndex={35}>기관모집</Link>
                    </div>
                    <div className="menu-list">
                      <Link to="/" tabIndex={37}>공지사항</Link>
                      <Link to="/" tabIndex={38}>자료실</Link>
                      <Link to="/" tabIndex={39}>정기간행물</Link>
                      <Link to="/" tabIndex={40}>자주묻는질문</Link>
                    </div>
                    <div className="menu-list">
                      <Link to="/" tabIndex={42}>기관장 인사말</Link>
                      <Link to="/" tabIndex={43}>스마트제조혁신추진단 소개</Link>
                      <Link to="/" tabIndex={44}>조직도</Link>
                      <Link to="/" tabIndex={45}>찾아오시는길</Link>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="eu-user-body" onScroll={handleScroll}>
          <section className="eu-u-main-bg">
            <div className="inner grid-col-2 item-center">
              <div className="title-wrap flex-col">
                <div className="title-en">Smart Factory Business Management System</div>
                <div className="title">스마트공장 견학</div>
                <div className="title-sub">스마트제조혁신의 함성, 함께 성장하는 대한민국</div>
                <button className="title-more-btn mt-16">자세히보기<SwapRightOutlined className="text-icon-24 ml-16 mt-2" /></button>
                {/* 메일슬라이드 버튼제어 */}
          ...
          <section className="eu-u-main-business">
            <div className="inner">
              <div className="title-wrap">
                ...
                <div className="scroll-x-hide ml-60">
                  ...
                  <div className="business-tab">
                    <button className="biz-tab-btn">전체</button>
                    <div className="flex-row-center mlr-60">
                      <button className="btn-slide-prev" onClick={slickPrevClick}><ArrowLeftOutlined /></button>
                      <button className="btn-slide-pause" onClick={slickStopSlide}>
                        {slickPlayPause === true 
                          ? <PauseOutlined className="pause ml-2" /> 
                          : <CaretRightOutlined className="ml-2" />}
                      </button>
                      <button className="btn-slide-next" onClick={slickNextClick}><ArrowRightOutlined /></button>
                    </div>
                    <Slider className="biz-tab-slide" 
                      ref={setSliderRef} {...settingsBizTab}>
                      <a href={"#/"}>시범공장<span></span></a>
                      <a href={"#/"}>업종별특화<span></span></a>
                      <a href={"#/"}>인공지능스마트공장<span></span></a>
                      <a href={"#/"}>디지털 클러스터<span></span></a>
                      <a href={"#/"}>탄소중립형<span></span></a>
                      <a href={"#/"}>로봇활용제조혁신지원<span></span></a>

                      <a href={"#/"}>1.시범공장<span></span></a>
                      <a href={"#/"}>2.업종별특화<span></span></a>
                      <a href={"#/"}>3.인공지능스마트공장<span></span></a>
                      <a href={"#/"}>4.디지털 클러스터<span></span></a>
                      <a href={"#/"}>5.탄소중립형<span></span></a>
                      <a href={"#/"}>6.로봇활용제조혁신지원<span></span></a>
                    </Slider>
                  </div>
                  {/* 사업공고 슬라이드 탭 - end */}
                </div>
              ...
              <div className="scroll-x-hide">
                <div className="grid-col-3 mt-70" style={{ minHeight: "222px" }}>
                          ...
                          <div className="cont-wrap">
                            <div className="flex-col-fit">
                              ...
                              {obj.date2 === '' 
                                ...
                                <div className="cont-date">
                                  {obj.date}<br/>
                                  <div className="text-c">{obj.date2}</div>
                                </div>
                              }
            ...
            <div className="inner">
              <div className="quick-menu-wrap">
                {dataQuickMenu.map((obj, index) => {
                  return(
                    <a href={"#/"} 
                      className={scrollTop < 500 
                        ? `circle-wrap flex-col-center ani-${index + 1}`
                        : `circle-wrap flex-col-center ani-${index + 1} on`
                      }
                    >
                      <div key={obj.imgPath} className="circle flex-row-center">
                        <img src={require(`css/images/user-icons/quick-menu-icon-${index + 1}.png`)} alt="바로가기" />
                      </div>
                      <div className="mt-14">{obj.text}</div>
                    </a>
                  )
                })}
              </div>
          ...
          <section className="eu-u-main-chart">
            <div className="inner">
              <div className="grid-col-2 gap-col-90 gap-row-60">
                ...
                <div className={scrollTop < 800 ? `chart-wrap up-down-ani` : `chart-wrap up-down-ani on`}>
                  {/* <div className="title">
                    현재 성장한 많은 기업들이<br/>
                    스마트제조혁신 추진단과 함께하였습니다.
                  </div> */}
                  <div className={scrollTop < 800 ? `title` : `title ani-delay`}>
                    현재 성장한 많은 기업들이<br/>
                    스마트제조혁신 추진단과 함께하였습니다.
                  </div>
                  <div className="sub-title">스마트공장 도입 후 성과를 확인하세요.</div>
                  <div className="chart-bg ani">
                    <div className="chart-title">공정개선 성과</div>
                    <div className="chart"></div>
                  </div>
                  <div className="chart-bg ani">
                    <div className="chart-title">경영개선 성과</div>
                    <div className="chart"></div>
                  </div>
                </div>
                {/* 오른쪽 */}
                {/* <div className="notice-wrap"> */}
                <div className={scrollTop < 800 ? `notice-wrap up-down-ani` : `notice-wrap up-down-ani on`}>
                  ...
                  <div className="eu-banner-wrap img-ani-bg">
                    <div className="sub-title">스마트제조혁신의 시작 스마트공장</div>
                    <div className="title">2022 스마트제조혁신대전</div>
                    <div className="text">
                      2022-12.05 - 2022-12.07<br/>
                      aT센터 (서울 서초구 강남대로 27)
                    </div>
          ...
          <section className={scrollTop < 1800 ? `eu-u-main-case up-down-ani` : `eu-u-main-case up-down-ani on`}>
            <div className="inner">
              <div className="grid-col-4 gap-36">
                <div className="col-span-1">
                  <div className="title-wrap">
                    {/* <div className="title ani-delay">우수구축사례</div> */}
                    <div className={scrollTop < 1800 ? `title` : `title ani-delay`}>우수구축사례</div>
                    <div className="sub-title mtb-20 ani">스마트공장 우수구축사례를<br/>자세히 보실 수 있습니다.</div>
                    <button className="title-more-btn mt-16 mr-4 ani-btn">자세히보기<SwapRightOutlined className="text-icon-24 ml-16" /></button>
                  </div>
                </div>
                  ...
                  <Slider {...settingsCase} className="case-slide">
                    <div className="content-wrap">
                      ...
                      <div className="cont-text">
                        <div className="title">(주)부성</div>
                        <div className="sub">직물, 편조원단, 의료복 염색 가공법</div>
                      </div>
                    </div>
                    <div className="content-wrap">
                      <div className="cont-img">
                      ...
                      <div className="cont-text">
                        <div className="title">(주)엘브리지</div>
                        <div className="sub">의약품, 건강기능식품 제조 및 유통</div>
                      </div>
                    </div>
                    <div className="content-wrap">
                      <div className="cont-img">
                      ...
                      <div className="cont-text">
                        <div className="title">(주)삼천산업</div>
                        <div className="sub">가정용 전기기기 제조업</div>
                      </div>
                    </div>
                    <div className="content-wrap">
                      <div className="cont-img">
                      ...
                      <div className="cont-text">
                        <div className="title">(주)부성</div>
                        <div className="sub">직물, 편조원단, 의료복 염색 가공법직물, 편조원단, 의료복 <br/>염색 가공법</div>
                      </div>
                    </div>
                  </Slider>
                </div>
          ...
          <section className={scrollTop < 2400 ? `eu-u-main-media up-down-ani` : `eu-u-main-media up-down-ani on`}>
            <div className="inner">
              <div className="title-wrap">
                {/* <div className="title">미디어센터</div> */}
                <div className={scrollTop < 2400 ? `title` : `title ani-delay`}>미디어센터</div>
                <div className="sub-title ml-20">스마트공장 사업관리시스템 공식 유튜브 채널입니다.</div>
                <button className="title-more-btn ml-auto mr-2 ani-btn">자세히보기<SwapRightOutlined className="text-icon-24 ml-16" /></button>
              </div>
