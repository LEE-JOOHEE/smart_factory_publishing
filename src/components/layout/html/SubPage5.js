...
const SubPage5 = ({ children }) => {
  ...
  return(
    <>
      ...
      <Row>
        <Col span={16}>
          <div className="headline mb-8">구축실적 검색조건</div>
        </Col>
        <Col span={8} className="text-r">
          <Button className="eu-btn-crud-fine">조회하기</Button>
        </Col>
        <Col span={24}>
          <div className="eu-table-indicator mb-8">
        ...
        <Col span={24}>
          <Descriptions size={'small'} bordered>
            <Descriptions.Item label="공급기업소재지" className="break">
              <Select
            ...
            <Descriptions.Item label="기업제조혁신역량 수준" className="break">
              <Select
                getPopupContainer={trigger => trigger.parentNode}
                dropdownAlign={{ offset: [0, 0] }}
                onChange={(value) => {
