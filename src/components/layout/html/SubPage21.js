      ...
      <Row>
        <Col span={24}>
          <div className="sub-tab-cont-wrap">
            ...
            <div className="font-16-400">
              ① 가입 신청자가 당 사업관리시스템 서비스 가입 절차를 완료하는 순간부터 귀하는 입력한 정보의 비밀을 유지할 책임이 있으며, 회원의 ID와 비밀번호를 사용하여
              발생하는 모든 결과에 대한 책임은 회원본인에게 있습니다.
            </div>
            <div className="font-16-400 mt-10">
              ② ID와 비밀번호에 관한 모든 관리의 책임은 회원에게 있으며, 회원의 ID나 비밀번호가 부정하게 사용 되었다는 사실을 발견한 경우에는 즉시 당 사업관리시스템에
              신고하여야 합니다. 신고를 하지 않음으로 인한 모든 책임은 회원 본인에게 있습니다.
            </div>
            <div className="font-16-400 mt-10">
              ③ 이용자는 당 사업관리시스템 서비스의 사용 종료시 마다 정확히 접속을 종료하도록 해야 하며, 정확히 종료하지 아니함으로써 제3자가 귀하에 관한 정보를 이용하게
              되는 등의 결과로 인해 발생하는 손해 및 손실에 대하여 당 사업관리시스템은 책임을 부담하지 아니합니다.
            </div>
            <div className="font-16-400 mt-10">
            ...
            <div className="font-16-400 mt-10">
              ⑤ 당 사업관리시스템은 수집·활용 중인 개인정보가 누출되고 그 사실을 인지시 개인정보 항목 및 발생시점 경위를 사용자에게 통보한다.
            </div>

            <div className="tit-blue mt-30">제8조(서비스이용시간)</div>
            <div className="font-16-400">
              ① 서비스 이용시간은 당 사업관리시스템의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간을 원칙으로 합니다.
            </div>
            <div className="font-16-400 mt-10">
              ② 제1항의 이용시간은 정기점검 등의 필요로 인하여 당 사업관리시스템이 정한 날 또는 시간은 예외로 합니다.
            </div>

            <div className="tit-blue mt-30">제9조(서비스의중지및정보의저장과사용)</div>
            <div className="font-16-400">
              ① 귀하는 당 사업관리시스템 서비스에 보관되거나 전송된 메시지 및 기타 통신 메시지 등의 내용이 국가의 비상사태, 정전, 당 사업관리시스템의 관리 범위 외의 서비스
              설비 장애 및 기타 불가항력에 의하여 보관되지 못하였거나 삭제된 경우, 전송되지 못한 경우 및 기타 통신 데이터의 손실이 있을 경우에 당 사업관리시스템은 관련
              책임을 지지 아니합니다.
            </div>
            <div className="font-16-400 mt-10">
              ② 당 사업관리시스템이 정상적인 서비스 제공의 어려움으로 인하여 일시적으로 서비스를 중지하여야 할 경우에는 서비스 중지 1주일 전의 고지 후 서비스를 중지할 수
              있으며, 이 기간 동안 귀하가 고지내용을 인지하지 못한 데 대하여 당 사업관리시스템은 책임을 부담하지 아니합니다.부득이한 사정이 있을 경우 위 사전 고지기간은
              감축되거나 생략될 수 있습니다. 또한 위 서비스 중지에 의하여 본 서비스에 보관되거나 전송된 메시지 및 기타 통신 메시지 등의 내용이 보관되지 못하였거나
              삭제된 경우, 전송되지 못한 경우 및 기타 통신 데이터의 손실이 있을 경우에 대하여도 당 사업관리시스템은 책임을 부담하지 아니합니다.
            </div>
            <div className="font-16-400 mt-10">
              ③ 당 사업관리시스템의 사정으로 서비스를 영구적으로 중단하여야 할 경우 제 2 항에 의거합니다. 다만, 이 경우 사전 고지기간은 1개월로 합니다.
            </div>
            <div className="font-16-400 mt-10">
              ④ 당 사업관리시스템은 사전 고지 후 서비스를 일시적으로 수정, 변경 및 중단할 수 있으며, 이에 대하여 귀하 또는 제3자에게 어떠한 책임도 부담하지 아니합니다.
            </div>
            <div className="font-16-400 mt-10">
              ⑤ 당 사업관리시스템은 이용자가 본 약관의 내용에 위배되는 행동을 한 경우, 임의로 서비스 사용을 제한 및 중지 할 수 있습니다. 이 경우 당 사업관리시스템은 위 이용자의
              접속을 금지할 수 있습니다.
            </div>

            <div className="tit-blue mt-30">제10조(서비스의변경및해지)</div>
            <div className="font-16-400">
              당 사업관리시스템은 귀하가 서비스를 이용하여 기대하는 손익이나 서비스를 통하여 얻은 자료로 인한 손해에 관하여 책임을 지지 않으며, 회원이 본 서비스에 게재한
